        ...
        <div class="col-md-6 col-lg-5">
            <div class="card shadow-lg">
                <div class="card-header text-center py-4" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; position: relative; overflow: hidden;">
                    ...
                    <h2 class="mb-0" style="position: relative; z-index: 1; font-weight: 700;">{{ __('Login') }}</h2>
                    <p class="mb-0 mt-2" style="opacity: 0.9; position: relative; z-index: 1;">{{ __('messages.welcome_back') }}</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="user-form">
                        ...
                        <div class="text-center">
                            @if (Route::has('password.request'))
                                <a class="text-decoration-none d-block mb-3" href="{{ route('password.request') }}" style="color: #4facfe; font-weight: 500;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form && submitBtn) {
        form.addEventListener('submit', function() {
            ...
            submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>{{ __("messages.logging_in") }}';
        });
    }
