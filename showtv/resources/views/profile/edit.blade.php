                    ...
                    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                ...
                                @enderror
                                <div class="mt-2">
                                    <img src="{{ $user->profile_image ? asset('storage/' . $user->profile_image) : 'https://www.gravatar.com/avatar/' . md5(strtolower(trim($user->email))) . '?s=120' }}" alt="{{ $user->name }}" class="rounded" style="width:96px;height:96px;object-fit:cover;">
                                </div>
                            </div>
                        </div>
