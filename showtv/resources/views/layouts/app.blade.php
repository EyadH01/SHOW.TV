        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('home') }}">
                            <i class="fas fa-home"></i> <span class="nav-text">{{ __('nav.home') }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('shows.index') }}">
                            <i class="fas fa-tv"></i> <span class="nav-text">{{ __('nav.shows') }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <form action="{{ route('search') }}" method="GET" class="d-flex">
                            <input class="form-control search-box me-2" type="search" id="voice-search" name="q" placeholder="{{ __('nav.search_placeholder') }}">
                            <button class="btn btn-outline-danger me-1" type="submit">
                                <i class="fas fa-search"></i>
                            </button>
                            <button class="btn btn-outline-primary" type="button" id="voice-btn" title="{{ __('nav.voice_search') }}">
                ...
                <ul class="navbar-nav ms-auto">
                    <!-- Theme Toggle -->
                    <li class="nav-item">
                        <button class="btn btn-link nav-link" id="theme-toggle" title="{{ __('nav.toggle_theme') }}">
                    ...
                    <!-- Voice Navigation -->
                    <li class="nav-item">
                        <button class="btn btn-link nav-link" id="voice-nav-btn" title="{{ __('nav.voice_nav') }}">
                    ...
                    @guest
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('register') }}">
                                <i class="fas fa-user-plus"></i> {{ __('nav.register') }}
                            </a>
                        </li>
                    @else
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle d-flex flex-column align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown">
                                ...
                                @endif
                                <span style="font-size: 0.8rem;">{{ Auth::user()->name }}</span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                ...
                                @if(Auth::user()->role === 'admin')
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('admin.dashboard') }}">
                                        <i class="fas fa-cog"></i> {{ __('nav.admin_dashboard') }}
                                    </a></li>
                                @endif
                                <li><hr class="dropdown-divider"></li>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ route('home') }}" class="text-muted text-decoration-none">الرئيسية</a></li>
                        <li><a href="{{ route('shows.index') }}" class="text-muted text-decoration-none">المسلسلات</a></li>
                    </ul>
                </div>
                <div class="col-md-4 mb-3">
                    <h5>التواصل</h5>
