    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('admin.episodes.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>

                        <div class="mb-3">
                            <label for="show_id" class="form-label">المسلسل</label>
                            <select class="form-control <?php $__errorArgs = ['show_id'];
...
unset($__errorArgs, $__bag); ?>" id="show_id" name="show_id" required>
                                ...
                                <option value="<?php echo e($show->id); ?>"><?php echo e($show->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['show_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['airing_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="airing_time" name="airing_time" value="<?php echo e(old('airing_time')); ?>" placeholder="مثال: الثلاثاء @ 9:00 مساءً">
                                <?php $__errorArgs = ['airing_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="video_url" name="video_url" value="<?php echo e(old('video_url')); ?>" placeholder="https://www.youtube.com/embed/...">
...
unset($__errorArgs, $__bag); ?>" id="video_file" name="video_file" accept="video/*">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['youtube_video_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="youtube_video_id" name="youtube_video_id" value="<?php echo e(old('youtube_video_id')); ?>" placeholder="dQw4w9WgXcQ">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('admin.episodes.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eyadhs/Downloads/SHOW.TV_f/showtv_complete/showtv/resources/views/admin/episodes/create.blade.php ENDPATH**/ ?>