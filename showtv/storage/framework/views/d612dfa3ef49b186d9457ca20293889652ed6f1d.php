                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="role" class="form-control" name="role">
                                    <option value="user"><?php echo e(__('Regular User')); ?></option>
                                    <option value="admin"><?php echo e(__('Administrator')); ?></option>
                                </select>
                                <small class="text-muted"><?php echo e(__('Choose your account type (optional, defaults to Regular User)')); ?></small>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                                <small class="text-muted"><?php echo e(__('Optional: Upload a profile photo (max 2MB, jpeg, png, jpg, gif)')); ?></small>
                            </div>
                        </div>
